...
export const TERCIADO = () => {
  const product = [];

  product.push(...productos);

  const TERConstructor = () => {
  ...
  const PronosticoTERCNT = () => {
    const datos = TERConstructor();
  ...
  const TERCIADoConstructor = product
    .filter(
      (e) =>
        e.name.substring(0, 8).toUpperCase() === "TERCIADO" &&
        e.store === "constructor31"
  ...
  const TERCIADOfalabella = product
    .filter(
      (e) =>
        e.name.substring(0, 8).toUpperCase() === "TERCIADO" &&
        e.store === "falabella"
    ...
    datasets: [
      {
        ...
        data: TERCIADoConstructor,
        borderColor: "#cc8080",
        backgroundColor: " #990000",
      },
      {
        label: "Terciado / falabella",
        data: TERCIADOfalabella,
        borderColor: "#8cff8c",
